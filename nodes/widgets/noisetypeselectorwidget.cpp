...
NoiseTypeSelectorWidget::NoiseTypeSelectorWidget(QWidget* parent /*= nullptr*/)
    ...
    connect(
        noise_picker_, &QComboBox::currentIndexChanged, this,
        &NoiseTypeSelectorWidget::OnSelectorChanged_
    );
...
FastNoiseLite::NoiseType NoiseTypeSelectorWidget::ToFastNoiseEnum_(
    NoiseSelectorType type
) const {
